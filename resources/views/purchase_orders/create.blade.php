                                    ...
                                    <div class="section-body p-3 border rounded bg-light">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="supplier_id" id="supplier_id"
                                                class="form-select select2-init @error('supplier_id') is-invalid @enderror"
                                                required>
                                                ...
                                                <div class="row align-items-end">
                                                    <div class="col-md-4">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select
                                                                class="form-select sparepart-select @error('items.0.sparepart_id') is-invalid @enderror"
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="number"
                                                                class="form-control purchase-price-input @error('items.0.purchase_price') is-invalid @enderror"
                                                                name="items[0][purchase_price]" id="purchase_price-0"
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    name="items[0][quantity]" id="quantity-0"
                                                                    value="{{ old('items.0.quantity', 1) }}" min="1"
                                                                    required>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="date"
                                                                class="form-control @error('items.0.expired_date') is-invalid @enderror"
                                                                id="expired_date-0" name="items[0][expired_date]"
                                                                value="{{ old('items.0.expired_date') }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <textarea class="form-control" name="items[0][notes]" id="notes-0" rows="1"
                                                                placeholder="Catatan untuk item ini">{{ old('items.0.notes') }}</textarea>
                                                        </div>
                                                    </div>
...
@push('addon-script')
    <script>
        ...
        // Helper untuk potong text
        function truncateLabel(str, limit = 15) {
        ...
        function initializeSelect2(element) {
            ...
            element.select2({
                theme: "bootstrap-5",
                width: element.data('width') ? element.data('width') : (element.hasClass('w-100') ? '100%' :
                    'style'),
                placeholder: element.data('placeholder') || '-- Pilih Item --',
                allowClear: Boolean(element.data('allow-clear')),

                // Dropdown list tetap full text
                templateResult: function(data) {
                    return getFullText(data);
                },

                // Tampilan selected value → dipotong hanya Jika sparepart
                templateSelection: function(data) {
                    if (!data.id) return '-- Pilih Item --';
                    const full = getFullText(data);

                    // Jika select punya class .item-select → potong
                    if (element.hasClass('item-select')) {
                        return truncateLabel(full, 15);
                    }

                    // Jika bukan (misal supplier) → tampilkan full text
                    return full;
                },
        ...
        function addItemRow() {
            ...
            newRow.find(
                'label[for^="sparepart-0"], label[for^="purchase_price-0"], label[for^="quantity-0"], label[for^="expired_date-0"], label[for^="notes-0"], label[for^="item_subtotal_display-0"]'
            ).each(function() {
                    ...
                    if (res.exists) {
                        ...
                        if (!$('#invoice_number').next('.invalid-feedback').length) {
                            $('#invoice_number').after(
                                '<div class="invalid-feedback">Nomor invoice sudah digunakan.</div>');
                        }
                    } else {
