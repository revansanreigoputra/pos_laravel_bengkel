                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($sparepart->isDiscountActive())
                                                    ...
                                                    <span
                                                        class="badge bg-success ms-1">{{ $sparepart->discount_percentage }}%
                                                        OFF</span>
                                                @else
                                            ...
                                            <td class="text-center">
                                                ...
                                                @can('sparepart.delete')
                                                    ...
                                                    <x-modal.delete-confirm id="deleteSparepartModal-{{ $sparepart->id }}"
                                                        :route="route('sparepart.destroy', $sparepart->id)" item="{{ $sparepart->name }}"
