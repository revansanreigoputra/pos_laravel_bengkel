        ...
        <div class="col-12">
            <div class="summary-card">
                <div class="row">
                    ...
                    <div class="col-md-4 summary-item">
                        <h4>Rp {{ number_format($purchaseOrders->sum('total_price'), 0, ',', '.') }}</h4>
                        <p>Total Pengeluaran</p>
                    </div>
                    <div class="col-md-4 summary-item">
                        <h4>{{ $purchaseOrders->where('status', 'received')->count() }}</h4>
                        <p>Pembelian Diterima</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="print-summary">
        ...
        <div class="print-summary-content">
            <table style="width: 100%; border: 1px solid #000;">
                <tr>
                    <td style="border: 1px solid #000; padding: 5px;"><strong>Total Pembelian:</strong></td>
                    <td style="border: 1px solid #000; padding: 5px;">{{ $purchaseOrders->count() }} transaksi</td>
                </tr>
                <tr>
            ...
            <p style="margin-top: 20px; font-size: 10px; color: #666;">
                * Laporan ini mencakup semua transaksi pembelian sparepart dalam periode yang dipilih.<br>
