        ...
        <div class="card-body">
            ...
            <div class="card">
                {{-- <h3 class="card-header">
                    Total Transaksi {{ $status ? ucfirst($status) : 'Keseluruhan' }}: {{ $transactions->count() }}
                    transaksi
                        ...
                        <tbody>
                            @forelse ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $transaction->status == 'completed' ? 'bg-success' : ($transaction->status == 'pending' ? 'bg-warning' : 'bg-danger') }} text-white p-2">
