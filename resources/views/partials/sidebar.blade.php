    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li
                    class="nav-item dropdown {{ request()->is('kategori*', 'sparepart*', 'service*', 'supplier*', 'konsumen*', 'jenis-kendaraan*') ? 'active' : '' }}">
                    ...
                    <div
                        class="dropdown-menu {{ request()->is('kategori*', 'sparepart*', 'service*', 'supplier*', 'konsumen*', 'jenis-kendaraan*') ? 'show' : '' }}">
                ...
                <li
                    class="nav-item dropdown {{ request()->is('purchase_orders*', 'transaction*', 'stock-handle*') ? 'active' : '' }}">
                    <a class="nav-link dropdown-toggle" href="#"
                    ...
                    <div
                        class="dropdown-menu {{ request()->is('purchase_orders*', 'transaction*', 'stock-handle*') ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                @can('purchase_order.create')
                                    <a href="{{ route('purchase_orders.create') }}"
                                        class="dropdown-item {{ request()->is('purchase_orders/create') ? 'active' : '' }} 
                                    add-link"><span
                                            class="add-badge">+</span>Tambah Pembelian</a>
                                @endcan
                            </div>
                            <div class="dropdown-menu-column">
                                ...
                                <a href="{{ route('transaction.create') }}"
                                    class="dropdown-item {{ request()->is('transaction/create') ? 'active' : '' }} 
                                    add-link">
                                    <span class="add-badge">+</span>Tambah Penjualan</a>
                ...
                {{-- laporan --}}
                <li
                    class="nav-item dropdown {{ request()->is('laporan/penjualan') || request()->is('stok-sparepart') || request()->is('laporan/pembelian') ? 'active' : '' }}">
                    <a class="nav-link dropdown-toggle" href="#"
                    ...
                    <div
                        class="dropdown-menu {{ request()->is('laporan/penjualan') || request()->is('stok-sparepart') || request()->is('laporan/pembelian') ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                @can('report.purchase')
                ...
                @canany(['manual-book-kasir.view', 'manual-book-admin.view'])
                    <li
                        class="nav-item dropdown {{ request()->is('manual-book-kasir') || request()->is('manual-book-admin') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#"
                            aria-expanded="{{ request()->is('manual-book-kasir') || request()->is('manual-book-admin') ? 'true' : 'false' }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <div
                            class="dropdown-menu {{ request()->is('manual-book-kasir') || request()->is('manual-book-admin') ? 'show' : '' }}">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                ...
                                @endcan
                                @can('manual-book-kasir.view')
                                    <a class="dropdown-item" href="{{ asset('assets/manualbookkasir.pdf') }}"
                                        target="_blank">
                                        Manual Book Kasir
                                    </a>
                                @endcan
